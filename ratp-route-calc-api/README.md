...
```python
from ratp_route_calc import Client
...
```python
from ratp_route_calc import AuthenticatedClient
...
```python
from ratp_route_calc.models import MyDataModel
from ratp_route_calc.api.my_tag import get_my_data_model
from ratp_route_calc.types import Response
...
1. Any endpoint which did not have a tag will be in `ratp_route_calc.api.default`
