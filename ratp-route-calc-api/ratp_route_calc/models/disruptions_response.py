...
T = TypeVar("T", bound="DisruptionsResponse")


@_attrs_define
class DisruptionsResponse:
    pagination: Pagination | Unset = UNSET
    disruptions: list[Disruption] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        disruptions: list[dict[str, Any]] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        disruptions: list[Disruption] | Unset = UNSET
        if _disruptions is not UNSET:
            disruptions = []
            for disruptions_item_data in _disruptions:
                disruptions_item = Disruption.from_dict(disruptions_item_data)
        ...
        disruptions_response.additional_properties = d
