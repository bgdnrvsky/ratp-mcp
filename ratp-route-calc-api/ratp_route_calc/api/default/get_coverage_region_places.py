...
from ...models.get_coverage_region_places_response_200 import GetCoverageRegionPlacesResponse200
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GetCoverageRegionPlacesResponse200.from_dict(response.json())
