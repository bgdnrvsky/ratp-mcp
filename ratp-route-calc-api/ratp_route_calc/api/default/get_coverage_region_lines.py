...
from ...models.lines_response import LinesResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> LinesResponse | None:
    if response.status_code == 200:
        response_200 = LinesResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[LinesResponse]:
    return Response(
