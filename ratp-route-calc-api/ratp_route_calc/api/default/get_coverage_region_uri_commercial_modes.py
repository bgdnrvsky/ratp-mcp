...
from ...models.get_coverage_region_uri_commercial_modes_response_200 import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/{uri}/commercial_modes".format(
...
) -> GetCoverageRegionUriCommercialModesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriCommercialModesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriCommercialModesResponse200]:
    return Response(
