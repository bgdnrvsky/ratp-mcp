...
from ...models.get_coverage_region_uri_networks_response_200 import GetCoverageRegionUriNetworksResponse200
...
) -> GetCoverageRegionUriNetworksResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriNetworksResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriNetworksResponse200]:
    return Response(
