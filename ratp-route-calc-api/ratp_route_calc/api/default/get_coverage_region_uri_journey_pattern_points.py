...
from ...models.get_coverage_region_uri_journey_pattern_points_response_200 import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/{uri}/journey_pattern_points".format(
...
) -> GetCoverageRegionUriJourneyPatternPointsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriJourneyPatternPointsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriJourneyPatternPointsResponse200]:
    return Response(
