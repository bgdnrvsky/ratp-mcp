...
from ...models.get_coverage_region_uri_traffic_reports_response_200 import GetCoverageRegionUriTrafficReportsResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/{uri}/traffic_reports".format(
...
) -> GetCoverageRegionUriTrafficReportsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriTrafficReportsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriTrafficReportsResponse200]:
    return Response(
