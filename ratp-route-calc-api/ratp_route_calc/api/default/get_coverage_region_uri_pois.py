...
from ...models.get_coverage_region_uri_pois_response_200 import GetCoverageRegionUriPoisResponse200
...
) -> GetCoverageRegionUriPoisResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriPoisResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriPoisResponse200]:
    return Response(
