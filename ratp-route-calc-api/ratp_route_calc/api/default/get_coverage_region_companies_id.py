...
from ...models.get_coverage_region_companies_id_response_200 import GetCoverageRegionCompaniesIdResponse200
...
) -> GetCoverageRegionCompaniesIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionCompaniesIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionCompaniesIdResponse200]:
    return Response(
