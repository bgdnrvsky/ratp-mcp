...
from ...models.get_coverage_region_journey_patterns_response_200 import GetCoverageRegionJourneyPatternsResponse200
...
) -> GetCoverageRegionJourneyPatternsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionJourneyPatternsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionJourneyPatternsResponse200]:
    return Response(
