...
from ...models.get_coverage_region_uri_poi_types_response_200 import GetCoverageRegionUriPoiTypesResponse200
...
) -> GetCoverageRegionUriPoiTypesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriPoiTypesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriPoiTypesResponse200]:
    return Response(
