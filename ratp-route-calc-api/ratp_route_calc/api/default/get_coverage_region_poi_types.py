...
from ...models.get_coverage_region_poi_types_response_200 import GetCoverageRegionPoiTypesResponse200
...
) -> GetCoverageRegionPoiTypesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionPoiTypesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionPoiTypesResponse200]:
    return Response(
