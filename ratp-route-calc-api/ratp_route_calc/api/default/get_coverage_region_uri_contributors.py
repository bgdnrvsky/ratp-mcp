...
from ...models.get_coverage_region_uri_contributors_response_200 import GetCoverageRegionUriContributorsResponse200
...
) -> GetCoverageRegionUriContributorsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriContributorsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriContributorsResponse200]:
    return Response(
