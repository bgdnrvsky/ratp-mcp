...
from ...models.get_coverage_region_uri_lines_id_response_200 import GetCoverageRegionUriLinesIdResponse200
...
) -> GetCoverageRegionUriLinesIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriLinesIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriLinesIdResponse200]:
    return Response(
