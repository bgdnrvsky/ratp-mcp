...
from ...models.stop_areas_response import StopAreasResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> StopAreasResponse | None:
    if response.status_code == 200:
        response_200 = StopAreasResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[StopAreasResponse]:
    return Response(
