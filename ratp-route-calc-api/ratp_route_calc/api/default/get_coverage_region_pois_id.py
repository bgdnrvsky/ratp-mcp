...
from ...models.get_coverage_region_pois_id_response_200 import GetCoverageRegionPoisIdResponse200
...
) -> GetCoverageRegionPoisIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionPoisIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionPoisIdResponse200]:
    return Response(
