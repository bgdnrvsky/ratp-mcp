...
from ...models.get_coverage_region_datasets_response_200 import GetCoverageRegionDatasetsResponse200
...
) -> GetCoverageRegionDatasetsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionDatasetsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionDatasetsResponse200]:
    return Response(
