...
from ...models.get_coverage_region_routes_response_200 import GetCoverageRegionRoutesResponse200
...
) -> GetCoverageRegionRoutesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionRoutesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionRoutesResponse200]:
    return Response(
