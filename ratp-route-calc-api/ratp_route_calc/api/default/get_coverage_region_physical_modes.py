...
from ...models.get_coverage_region_physical_modes_response_200 import GetCoverageRegionPhysicalModesResponse200
...
) -> GetCoverageRegionPhysicalModesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionPhysicalModesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionPhysicalModesResponse200]:
    return Response(
