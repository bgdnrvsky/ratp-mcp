...
from ...models.get_coverage_region_uri_route_schedules_response_200 import GetCoverageRegionUriRouteSchedulesResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/{uri}/route_schedules".format(
...
) -> GetCoverageRegionUriRouteSchedulesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriRouteSchedulesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriRouteSchedulesResponse200]:
    return Response(
