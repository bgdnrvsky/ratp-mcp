...
from ...models.get_coverage_region_line_groups_id_response_200 import GetCoverageRegionLineGroupsIdResponse200
...
) -> GetCoverageRegionLineGroupsIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionLineGroupsIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionLineGroupsIdResponse200]:
    return Response(
