...
from ...models.get_coverage_region_trips_response_200 import GetCoverageRegionTripsResponse200
...
) -> GetCoverageRegionTripsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionTripsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionTripsResponse200]:
    return Response(
