...
from ...models.get_coverage_region_places_nearby_response_200 import GetCoverageRegionPlacesNearbyResponse200
...
) -> GetCoverageRegionPlacesNearbyResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionPlacesNearbyResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionPlacesNearbyResponse200]:
    return Response(
