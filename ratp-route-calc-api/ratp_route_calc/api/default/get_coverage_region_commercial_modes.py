...
from ...models.get_coverage_region_commercial_modes_response_200 import GetCoverageRegionCommercialModesResponse200
...
) -> GetCoverageRegionCommercialModesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionCommercialModesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionCommercialModesResponse200]:
    return Response(
