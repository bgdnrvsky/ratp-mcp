...
from ...models.get_coverage_region_uri_vehicle_journeys_response_200 import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/{uri}/vehicle_journeys".format(
...
) -> GetCoverageRegionUriVehicleJourneysResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriVehicleJourneysResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriVehicleJourneysResponse200]:
    return Response(
