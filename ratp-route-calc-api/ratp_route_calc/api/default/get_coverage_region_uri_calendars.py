...
from ...models.get_coverage_region_uri_calendars_response_200 import GetCoverageRegionUriCalendarsResponse200
...
) -> GetCoverageRegionUriCalendarsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriCalendarsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriCalendarsResponse200]:
    return Response(
