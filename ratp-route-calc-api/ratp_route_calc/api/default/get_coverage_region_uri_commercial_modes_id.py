...
from ...models.get_coverage_region_uri_commercial_modes_id_response_200 import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/{uri}/commercial_modes/{id}".format(
...
) -> GetCoverageRegionUriCommercialModesIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriCommercialModesIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriCommercialModesIdResponse200]:
    return Response(
