...
from ...models.get_coverage_region_uri_journey_patterns_id_response_200 import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/{uri}/journey_patterns/{id}".format(
...
) -> GetCoverageRegionUriJourneyPatternsIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriJourneyPatternsIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriJourneyPatternsIdResponse200]:
    return Response(
