...
from ...models.get_coverage_region_journey_pattern_points_id_response_200 import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/journey_pattern_points/{id}".format(
...
) -> GetCoverageRegionJourneyPatternPointsIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionJourneyPatternPointsIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionJourneyPatternPointsIdResponse200]:
    return Response(
