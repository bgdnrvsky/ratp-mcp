...
from ...models.get_coverage_region_commercial_modes_id_response_200 import GetCoverageRegionCommercialModesIdResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/commercial_modes/{id}".format(
...
) -> GetCoverageRegionCommercialModesIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionCommercialModesIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionCommercialModesIdResponse200]:
    return Response(
