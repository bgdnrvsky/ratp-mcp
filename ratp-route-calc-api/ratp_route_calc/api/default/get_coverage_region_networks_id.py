...
from ...models.get_coverage_region_networks_id_response_200 import GetCoverageRegionNetworksIdResponse200
...
) -> GetCoverageRegionNetworksIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionNetworksIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionNetworksIdResponse200]:
    return Response(
