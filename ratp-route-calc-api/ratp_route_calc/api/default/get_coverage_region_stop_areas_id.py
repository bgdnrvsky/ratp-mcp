...
from ...models.get_coverage_region_stop_areas_id_response_200 import GetCoverageRegionStopAreasIdResponse200
...
) -> GetCoverageRegionStopAreasIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionStopAreasIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionStopAreasIdResponse200]:
    return Response(
