...
from ...models.get_coverage_region_journey_patterns_id_response_200 import GetCoverageRegionJourneyPatternsIdResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/journey_patterns/{id}".format(
...
) -> GetCoverageRegionJourneyPatternsIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionJourneyPatternsIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionJourneyPatternsIdResponse200]:
    return Response(
