...
from ...models.get_coverage_region_uri_departures_response_200 import GetCoverageRegionUriDeparturesResponse200
...
) -> GetCoverageRegionUriDeparturesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriDeparturesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriDeparturesResponse200]:
    return Response(
