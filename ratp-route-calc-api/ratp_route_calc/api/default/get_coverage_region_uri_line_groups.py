...
from ...models.get_coverage_region_uri_line_groups_response_200 import GetCoverageRegionUriLineGroupsResponse200
...
) -> GetCoverageRegionUriLineGroupsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriLineGroupsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriLineGroupsResponse200]:
    return Response(
