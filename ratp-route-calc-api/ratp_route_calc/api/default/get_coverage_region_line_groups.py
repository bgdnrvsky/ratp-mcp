...
from ...models.get_coverage_region_line_groups_response_200 import GetCoverageRegionLineGroupsResponse200
...
) -> GetCoverageRegionLineGroupsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionLineGroupsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionLineGroupsResponse200]:
    return Response(
