...
from ...models.get_coverage_region_uri_stop_areas_id_response_200 import GetCoverageRegionUriStopAreasIdResponse200
...
) -> GetCoverageRegionUriStopAreasIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriStopAreasIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriStopAreasIdResponse200]:
    return Response(
