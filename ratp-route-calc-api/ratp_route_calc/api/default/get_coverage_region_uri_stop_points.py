...
from ...models.get_coverage_region_uri_stop_points_response_200 import GetCoverageRegionUriStopPointsResponse200
...
) -> GetCoverageRegionUriStopPointsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriStopPointsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriStopPointsResponse200]:
    return Response(
