...
from ...models.get_coverage_region_poi_types_id_response_200 import GetCoverageRegionPoiTypesIdResponse200
...
) -> GetCoverageRegionPoiTypesIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionPoiTypesIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionPoiTypesIdResponse200]:
    return Response(
