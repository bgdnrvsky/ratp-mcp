...
from ...models.get_coverage_region_uri_disruptions_id_response_200 import GetCoverageRegionUriDisruptionsIdResponse200
...
) -> GetCoverageRegionUriDisruptionsIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriDisruptionsIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriDisruptionsIdResponse200]:
    return Response(
