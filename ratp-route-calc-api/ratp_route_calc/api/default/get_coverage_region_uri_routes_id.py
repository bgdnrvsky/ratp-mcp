...
from ...models.get_coverage_region_uri_routes_id_response_200 import GetCoverageRegionUriRoutesIdResponse200
...
) -> GetCoverageRegionUriRoutesIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriRoutesIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriRoutesIdResponse200]:
    return Response(
