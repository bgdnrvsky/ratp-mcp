...
from ...models.get_coverage_region_uri_trips_response_200 import GetCoverageRegionUriTripsResponse200
...
) -> GetCoverageRegionUriTripsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriTripsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriTripsResponse200]:
    return Response(
