...
from ...models.get_coverage_region_uri_poi_types_id_response_200 import GetCoverageRegionUriPoiTypesIdResponse200
...
) -> GetCoverageRegionUriPoiTypesIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriPoiTypesIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriPoiTypesIdResponse200]:
    return Response(
