...
from ...models.get_coverage_region_uri_line_groups_id_response_200 import GetCoverageRegionUriLineGroupsIdResponse200
...
) -> GetCoverageRegionUriLineGroupsIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriLineGroupsIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriLineGroupsIdResponse200]:
    return Response(
