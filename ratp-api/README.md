# navitia-client
A client library for accessing Navitia
...
```python
from navitia_client import AuthenticatedClient
...
```python
from navitia_client.models import MyDataModel
from navitia_client.api.my_tag import get_my_data_model
from navitia_client.types import Response
...
1. Any endpoint which did not have a tag will be in `navitia_client.api.default`
