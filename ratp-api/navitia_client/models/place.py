...
from ..models.place_embedded_type import PlaceEmbeddedType
...
class Place:
    ...
    Attributes:
        ...
        distance (str | Unset): Distance to the object in meters
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        embedded_type = PlaceEmbeddedType(d.pop("embedded_type"))
