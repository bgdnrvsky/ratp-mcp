...
class Journey:
    """
    Attributes:
        status (str): Status from the whole journey taking into account the most disturbing information retrieved on
            every object used (can be "NO_SERVICE", "SIGNIFICANT_DELAYS", ...
        tags (list[str]):
        nb_transfers (int): Number of transfers along the journey
        fare (Fare):
        co2_emission (Amount):
        type_ (str): Used to qualify the journey (can be "best", "comfort", "non_pt_walk", ...
        ...
        arrival_date_time (str | Unset): Arrival date and time of the journey
        calendars (list[Calendar] | Unset):
        departure_date_time (str | Unset): Departure date and time of the journey
        to (Place | Unset):
        requested_date_time (str | Unset):
        sections (list[Section] | Unset):
