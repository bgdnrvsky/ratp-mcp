...
class ImpactedStop:
    ...
    Attributes:
        is_detour (bool):
        cause (str):
        amended_arrival_time (str | Unset):
        stop_point (StopPoint | Unset):
        stop_time_effect (ImpactedStopStopTimeEffect | Unset):
        departure_status (str | Unset):
        amended_departure_time (str | Unset):
        base_arrival_time (str | Unset):
        base_departure_time (str | Unset):
        arrival_status (str | Unset):
    """
