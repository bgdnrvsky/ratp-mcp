...
class JourneyDebug:
    """
    Attributes:
        nb_vj_extentions (int): Number of stay-in
        nb_sections (int): Number of sections
        streetnetwork_duration (int): Total duration of streetnetwork use (seconds)
        transfer_duration (int): Total duration of transfers (seconds)
        min_waiting_duration (int): Minimum on all waiting durations (seconds)
