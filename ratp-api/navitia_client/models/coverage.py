...
class Coverage:
    ...
    Attributes:
        ...
        shape (str): GeoJSON of the shape of the coverage
        id (str): Identifier of the coverage
        status (str | Unset):
        dataset_created_at (str | Unset): Creation date of the dataset
        start_production_date (str | Unset): Beginning of the production period. We only have data on this production
            period
        end_production_date (str | Unset): End of the production period. We only have data on this production period
        error (CoverageError | Unset):
        last_load_at (str | Unset): Datetime of the last data loading
    """
