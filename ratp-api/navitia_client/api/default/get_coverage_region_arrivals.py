...
from ...models.get_coverage_region_arrivals_response_200 import GetCoverageRegionArrivalsResponse200
...
) -> GetCoverageRegionArrivalsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionArrivalsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionArrivalsResponse200]:
    return Response(
