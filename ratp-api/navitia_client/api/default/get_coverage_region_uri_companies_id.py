...
from ...models.get_coverage_region_uri_companies_id_response_200 import GetCoverageRegionUriCompaniesIdResponse200
...
) -> GetCoverageRegionUriCompaniesIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriCompaniesIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriCompaniesIdResponse200]:
    return Response(
