...
from ...models.get_coverage_region_uri_datasets_response_200 import GetCoverageRegionUriDatasetsResponse200
...
) -> GetCoverageRegionUriDatasetsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriDatasetsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriDatasetsResponse200]:
    return Response(
