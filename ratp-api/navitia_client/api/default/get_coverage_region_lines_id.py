...
from ...models.get_coverage_region_lines_id_response_200 import GetCoverageRegionLinesIdResponse200
...
) -> GetCoverageRegionLinesIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionLinesIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionLinesIdResponse200]:
    return Response(
