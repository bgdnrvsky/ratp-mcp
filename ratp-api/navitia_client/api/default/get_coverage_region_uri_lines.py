...
from ...models.get_coverage_region_uri_lines_response_200 import GetCoverageRegionUriLinesResponse200
...
) -> GetCoverageRegionUriLinesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriLinesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriLinesResponse200]:
    return Response(
