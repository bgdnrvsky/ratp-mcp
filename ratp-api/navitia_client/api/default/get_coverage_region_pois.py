...
from ...models.get_coverage_region_pois_response_200 import GetCoverageRegionPoisResponse200
...
) -> GetCoverageRegionPoisResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionPoisResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionPoisResponse200]:
    return Response(
