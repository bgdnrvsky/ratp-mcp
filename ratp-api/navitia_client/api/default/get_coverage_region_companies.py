...
from ...models.get_coverage_region_companies_response_200 import GetCoverageRegionCompaniesResponse200
...
) -> GetCoverageRegionCompaniesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionCompaniesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionCompaniesResponse200]:
    return Response(
