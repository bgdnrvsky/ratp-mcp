...
from ...models.get_coverage_region_uri_arrivals_response_200 import GetCoverageRegionUriArrivalsResponse200
...
) -> GetCoverageRegionUriArrivalsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriArrivalsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriArrivalsResponse200]:
    return Response(
