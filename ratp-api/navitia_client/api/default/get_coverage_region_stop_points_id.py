...
from ...models.get_coverage_region_stop_points_id_response_200 import GetCoverageRegionStopPointsIdResponse200
...
) -> GetCoverageRegionStopPointsIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionStopPointsIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionStopPointsIdResponse200]:
    return Response(
