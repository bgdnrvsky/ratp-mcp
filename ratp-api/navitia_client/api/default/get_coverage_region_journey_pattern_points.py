...
from ...models.get_coverage_region_journey_pattern_points_response_200 import (
...
) -> GetCoverageRegionJourneyPatternPointsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionJourneyPatternPointsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionJourneyPatternPointsResponse200]:
    return Response(
