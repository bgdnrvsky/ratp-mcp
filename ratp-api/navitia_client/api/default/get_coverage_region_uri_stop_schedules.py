...
from ...models.get_coverage_region_uri_stop_schedules_response_200 import GetCoverageRegionUriStopSchedulesResponse200
...
) -> GetCoverageRegionUriStopSchedulesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriStopSchedulesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriStopSchedulesResponse200]:
    return Response(
