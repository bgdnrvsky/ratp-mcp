...
from ...models.get_coverage_region_disruptions_response_200 import GetCoverageRegionDisruptionsResponse200
...
) -> GetCoverageRegionDisruptionsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionDisruptionsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionDisruptionsResponse200]:
    return Response(
