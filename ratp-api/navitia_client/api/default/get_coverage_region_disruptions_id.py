...
from ...models.get_coverage_region_disruptions_id_response_200 import GetCoverageRegionDisruptionsIdResponse200
...
) -> GetCoverageRegionDisruptionsIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionDisruptionsIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionDisruptionsIdResponse200]:
    return Response(
