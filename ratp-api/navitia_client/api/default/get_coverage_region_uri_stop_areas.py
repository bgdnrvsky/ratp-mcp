...
from ...models.get_coverage_region_uri_stop_areas_response_200 import GetCoverageRegionUriStopAreasResponse200
...
) -> GetCoverageRegionUriStopAreasResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriStopAreasResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriStopAreasResponse200]:
    return Response(
