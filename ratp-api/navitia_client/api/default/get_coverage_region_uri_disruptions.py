...
from ...models.get_coverage_region_uri_disruptions_response_200 import GetCoverageRegionUriDisruptionsResponse200
...
) -> GetCoverageRegionUriDisruptionsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriDisruptionsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriDisruptionsResponse200]:
    return Response(
