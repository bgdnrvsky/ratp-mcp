...
from ...models.get_coverage_region_uri_pois_id_response_200 import GetCoverageRegionUriPoisIdResponse200
...
) -> GetCoverageRegionUriPoisIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriPoisIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriPoisIdResponse200]:
    return Response(
