...
from ...models.get_coverage_region_uri_stop_points_id_response_200 import GetCoverageRegionUriStopPointsIdResponse200
...
) -> GetCoverageRegionUriStopPointsIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriStopPointsIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriStopPointsIdResponse200]:
    return Response(
