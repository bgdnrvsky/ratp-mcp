...
from ...models.get_coverage_region_uri_networks_id_response_200 import GetCoverageRegionUriNetworksIdResponse200
...
) -> GetCoverageRegionUriNetworksIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriNetworksIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriNetworksIdResponse200]:
    return Response(
