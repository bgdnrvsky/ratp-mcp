...
from ...models.get_coverage_region_stop_points_response_200 import GetCoverageRegionStopPointsResponse200
...
) -> GetCoverageRegionStopPointsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionStopPointsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionStopPointsResponse200]:
    return Response(
