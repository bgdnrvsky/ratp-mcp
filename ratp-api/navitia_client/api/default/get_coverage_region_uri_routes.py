...
from ...models.get_coverage_region_uri_routes_response_200 import GetCoverageRegionUriRoutesResponse200
...
) -> GetCoverageRegionUriRoutesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriRoutesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriRoutesResponse200]:
    return Response(
