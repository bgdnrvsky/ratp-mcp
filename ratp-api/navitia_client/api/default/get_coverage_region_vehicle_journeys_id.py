...
from ...models.get_coverage_region_vehicle_journeys_id_response_200 import GetCoverageRegionVehicleJourneysIdResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/vehicle_journeys/{id}".format(
...
) -> GetCoverageRegionVehicleJourneysIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionVehicleJourneysIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionVehicleJourneysIdResponse200]:
    return Response(
