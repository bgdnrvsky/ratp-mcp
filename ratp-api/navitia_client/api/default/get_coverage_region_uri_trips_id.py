...
from ...models.get_coverage_region_uri_trips_id_response_200 import GetCoverageRegionUriTripsIdResponse200
...
) -> GetCoverageRegionUriTripsIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriTripsIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriTripsIdResponse200]:
    return Response(
