...
from ...models.get_coverage_region_trips_id_response_200 import GetCoverageRegionTripsIdResponse200
...
) -> GetCoverageRegionTripsIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionTripsIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionTripsIdResponse200]:
    return Response(
