...
from ...models.get_coverage_region_physical_modes_id_response_200 import GetCoverageRegionPhysicalModesIdResponse200
...
) -> GetCoverageRegionPhysicalModesIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionPhysicalModesIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionPhysicalModesIdResponse200]:
    return Response(
