...
from ...models.get_coverage_region_lines_response_200 import GetCoverageRegionLinesResponse200
...
) -> GetCoverageRegionLinesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionLinesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionLinesResponse200]:
    return Response(
