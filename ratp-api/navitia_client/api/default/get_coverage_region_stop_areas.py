...
from ...models.get_coverage_region_stop_areas_response_200 import GetCoverageRegionStopAreasResponse200
...
) -> GetCoverageRegionStopAreasResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionStopAreasResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionStopAreasResponse200]:
    return Response(
