...
from ...models.get_coverage_region_uri_companies_response_200 import GetCoverageRegionUriCompaniesResponse200
...
) -> GetCoverageRegionUriCompaniesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriCompaniesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriCompaniesResponse200]:
    return Response(
