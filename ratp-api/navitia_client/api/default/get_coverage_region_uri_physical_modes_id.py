...
from ...models.get_coverage_region_uri_physical_modes_id_response_200 import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/{uri}/physical_modes/{id}".format(
...
) -> GetCoverageRegionUriPhysicalModesIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriPhysicalModesIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriPhysicalModesIdResponse200]:
    return Response(
