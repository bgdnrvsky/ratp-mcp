...
from ...models.get_coverage_region_uri_vehicle_journeys_id_response_200 import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/{uri}/vehicle_journeys/{id}".format(
...
) -> GetCoverageRegionUriVehicleJourneysIdResponse200 | None:
    if response.status_code == 200:
        response_200 = GetCoverageRegionUriVehicleJourneysIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetCoverageRegionUriVehicleJourneysIdResponse200]:
    return Response(
